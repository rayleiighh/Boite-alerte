...
import { getNotifications, markAllRead, markOneRead, deleteOne, subscribeRealtime } from "../services/notifications.api.js";
    ...
    <section className="notif-page">
      ...
      <div className="notif-toolbar">
        ...
        <div className="filters">
          ...
          <button className="pill ghost" onClick={onMarkAll}>Tout marquer lu</button>
        </div>
      </div>
      ...
      <div className="notif-grid">
        {filtered.length === 0 ? (
          <div className="empty">
            <div className="empty-icon" style={{color:"#6b7280"}}>{Icon.clock}</div>
          ...
          <article key={n.id} className={`card ${n.isNew ? "is-new" : ""}`}>
            ...
            <div className="card-body">
              ...
              <div className="row gap">
                ...
                {n.isNew ? (
                  <button className="mini" onClick={()=>onMarkOne(n.id)}>Marquer lu</button>
                ) : (
                  <span className="muted">lu</span>
                )}

                <button className="mini danger" onClick={()=>onDelete(n.id)}>Supprimer</button>
              </div>
            </div>
